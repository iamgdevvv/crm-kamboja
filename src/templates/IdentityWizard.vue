<template>
	<section class="entry-wizard entry-wizard__identitywizard" :class="className">
		<div class="header-wizard-content">
			<h3 class="title-wizard-content">Isi IdentityWizard tanggal lahir Anda</h3>
		...
		<aside class="wizard-sidebar">
			<button class="cta-submit-wizard" :class="{ 'prevent-submit':wizardInvalid }" @click.prevent="submitIdentity">Selanjutnya</button>
		</aside>
	</section>
</template>
